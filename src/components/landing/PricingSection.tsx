...
const plans = [
  {
    ...
    features: ["1 active project", "3 team members", "Basic task management", "1GB storage"],
    cta: "Get Started",
    highlighted: false,
  },
  {
    ...
    features: ["Unlimited projects", "25 team members", "Kanban boards", "Budget tracking", "Site updates", "25GB storage"],
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {plans.map((plan, i) => (
            ...
            >
              {plan.highlighted && (
                <span className="absolute -top-3 left-1/2 -translate-x-1/2 text-xs font-semibold px-3 py-1 rounded-full byld-gradient text-primary-foreground">
                  Most Popular
                </span>
              )}
