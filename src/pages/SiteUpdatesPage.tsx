import { Camera, Video, MessageSquare, Heart, MessageCircle, Plus, Tag } from "lucide-react";
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {(update.type === "photo" || update.type === "video") && (
                    <div className="rounded-lg bg-secondary/50 border border-border/30 h-48 flex items-center justify-center mb-3">
                  ...
                  {update.comments && update.comments.length > 0 && (
                    <div className="mt-3 space-y-2">
                      {update.comments.map((c, i) => (
                        <div key={i} className="flex items-start gap-2 pl-2 border-l-2 border-border/30">
