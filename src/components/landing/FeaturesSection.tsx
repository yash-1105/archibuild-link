...
import {
  LayoutDashboard, ListTodo, Camera, FileText, DollarSign, Bell, Shield, BarChart3,
} from "lucide-react";
    ...
    <section className="py-24 bg-secondary/20">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="text-sm font-semibold text-primary uppercase tracking-widest mb-3">
            Features
          </motion.p>
          <motion.h2 initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="font-display text-3xl md:text-4xl font-bold text-foreground">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {features.map((feature, i) => (
            <motion.div
              ...
              className="rounded-xl border border-border/50 bg-card p-6 byld-card-hover group"
            >
